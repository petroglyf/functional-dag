...
namespace fn_dag {
  ...
  private:
    ...
    vector< _abstract_internal_dag_node<Type, IDType> *> m_children; // Children to fan-out to
  ...
  public:
     ...
     * 
     * This node specifically fans data out and makes sure the children can't modify the
    ...
    */
     ...
     * children until it finds it. If the parent isn't found, it will return false.
     * 
